...
@Repository(value = "databaseQueryActionDao")
public class DatabaseQueryActionDaoImpl extends GenericDAOImpl<DatabaseQueryAction> implements IDatabaseQueryActionDao{
	...
	public List<DatabaseQueryAction> getAllDatabaseQueryActionsByQueryId(int queryId){
		Criteria criteria = getCurrentSession().createCriteria(DatabaseQueryAction.class);

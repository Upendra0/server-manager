...
@Component(value="NRTRDEParserMapping")
@Entity
@XmlRootElement
@DiscriminatorValue(EngineConstants.NRTRDE_PARSING_PLUGIN)
public class NRTRDEParserMapping extends ParserMapping{
	 ...
	 * 
	 * @return list of RAP IN ParserAttributes
	 */

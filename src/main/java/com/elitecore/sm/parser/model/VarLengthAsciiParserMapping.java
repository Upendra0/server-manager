 ...
 *
 */
@Component(value="varLengthAsciiParser")
@Entity
@DiscriminatorValue(EngineConstants.VARIABLE_LENGTH_ASCII_PARSING_PLUGIN)
@DynamicUpdate
@Cacheable
@Cache(usage=CacheConcurrencyStrategy.READ_WRITE, region="parserMappingCache")
public class VarLengthAsciiParserMapping extends ParserMapping {
	...
	private FileTypeEnum fileTypeEnum=FileTypeEnum.DELIMITER;

...
@XmlRootElement(name = "ftp-distribution-driver")
public class FTPDistributionDriverEntity {
    ...
    @Mapping("this")
    protected FTPDistributionDriverEntity.HostList hostList;
    ...
    protected FTPDistributionDriverEntity.PathList pathList;
    ...
    public FTPDistributionDriverEntity.HostList getHostList() {
        return hostList;
    }

    
    public void setHostList(FTPDistributionDriverEntity.HostList value) {
        this.hostList = value;
    }
    ...
    public FTPDistributionDriverEntity.PathList getPathList() {
        return pathList;
    }

    
    public void setPathList(FTPDistributionDriverEntity.PathList value) {
        this.pathList = value;
    }
    ...
    public static class PathList {
        ...
        protected List<FTPDistributionDriverEntity.PathList.Path> path;

        
        public List<FTPDistributionDriverEntity.PathList.Path> getPath() {
            if (path == null) {
                path = new ArrayList<>();
            }
            return this.path;
        ...
        public static class Path {
            ...
            @Mapping("this")
            protected FTPDistributionDriverEntity.PathList.Path.PluginList pluginList;
            ...
            public FTPDistributionDriverEntity.PathList.Path.PluginList getPluginList() {
                return pluginList;
            }

            
            public void setPluginList(FTPDistributionDriverEntity.PathList.Path.PluginList value) {
            ...
            public static class PluginList {
                ...
                protected List<FTPDistributionDriverEntity.PathList.Path.PluginList.Plugin> plugin;

                
                public List<FTPDistributionDriverEntity.PathList.Path.PluginList.Plugin> getPlugin() {
                    if (plugin == null) {
                ...
                public static class Plugin {
                    ...
                    @Mapping("this")
                    protected FTPDistributionDriverEntity.PathList.Path.PluginList.Plugin.CharacterRenamingOperation characterRenamingOperation;
					...
					public FTPDistributionDriverEntity.PathList.Path.PluginList.Plugin.CharacterRenamingOperation getCharacterRenamingOperation() {
                        return characterRenamingOperation;
                    }

                    
                    public void setCharacterRenamingOperation(FTPDistributionDriverEntity.PathList.Path.PluginList.Plugin.CharacterRenamingOperation value) {
                    ...
                    public static class CharacterRenamingOperation {
                        ...
                        protected List<FTPDistributionDriverEntity.PathList.Path.PluginList.Plugin.CharacterRenamingOperation.Character> character;

                        
                        public List<FTPDistributionDriverEntity.PathList.Path.PluginList.Plugin.CharacterRenamingOperation.Character> getCharacter() {
                            if (character == null) {
                        ...
                        public static class Character {
                            ...
                            @XmlElement(required = true)
                            @Mapping("this")
                            protected FTPDistributionDriverEntity.PathList.Path.PluginList.Plugin.CharacterRenamingOperation.Character.Padding padding;
                            ...
                            public FTPDistributionDriverEntity.PathList.Path.PluginList.Plugin.CharacterRenamingOperation.Character.Padding getPadding() {
                                return padding;
                            }

                            
                            public void setPadding(FTPDistributionDriverEntity.PathList.Path.PluginList.Plugin.CharacterRenamingOperation.Character.Padding value) {
                                this.padding = value;
                            }

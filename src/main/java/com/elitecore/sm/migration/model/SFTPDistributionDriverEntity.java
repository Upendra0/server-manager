...
@XmlType(name = "", propOrder = {
    ...
    "password",
    "maxRetryCount",
    "remoteSystemFileSeperator",
    "validateInProcessFile",
    "activeDistribution",
    "pathList"
})
@XmlRootElement(name = "sftp-distribution-driver")
public class SFTPDistributionDriverEntity {
    ...
    @Mapping("this")
    protected SFTPDistributionDriverEntity.HostList hostList;
    ...
    @Mapping("ftpConnectionParams.password")
    ...
    @XmlElement(name = "validate-inprocess-file", required = true)
    @Mapping("validateInProcessFile")
    protected String validateInProcessFile;
    
    @XmlElement(name = "active-distribution", required = true)
    @Mapping("activeDistribution")
    protected String activeDistribution;

    
    @XmlElement(name = "path-list", required = true)
    protected SFTPDistributionDriverEntity.PathList pathList;
    ...
    public SFTPDistributionDriverEntity.HostList getHostList() {
        return hostList;
    }

    
    public void setHostList(SFTPDistributionDriverEntity.HostList value) {
        this.hostList = value;
    }
    ...
    public short getFtpTimeout() {
        return ftpTimeout;
    }

    
    public void setFtpTimeout(short value) {
    ...
    public String getValidateInProcessFile() {
		return validateInProcessFile;
	}


	public void setValidateInProcessFile(String validateInProcessFile) {
		this.validateInProcessFile = validateInProcessFile;
	}

    
    public String getActiveDistribution() {
		return activeDistribution;
	}


	public void setActiveDistribution(String activeDistribution) {
		this.activeDistribution = activeDistribution;
	}


	public SFTPDistributionDriverEntity.PathList getPathList() {
        return pathList;
    }

    
    public void setPathList(SFTPDistributionDriverEntity.PathList value) {
        this.pathList = value;
    }
    ...
    public static class PathList {
        ...
        protected List<SFTPDistributionDriverEntity.PathList.Path> path;

        
        public List<SFTPDistributionDriverEntity.PathList.Path> getPath() {
            if (path == null) {
                path = new ArrayList<>();
            }
            return this.path;
        ...
        public static class Path {
            ...
            @Mapping("this")
            protected SFTPDistributionDriverEntity.PathList.Path.PluginList pluginList;
            ...
            public SFTPDistributionDriverEntity.PathList.Path.PluginList getPluginList() {
                return pluginList;
            }

            
            public void setPluginList(SFTPDistributionDriverEntity.PathList.Path.PluginList value) {
            ...
            public static class PluginList {
                ...
                protected List<SFTPDistributionDriverEntity.PathList.Path.PluginList.Plugin> plugin;

                public List<SFTPDistributionDriverEntity.PathList.Path.PluginList.Plugin> getPlugin() {
                    if (plugin == null) {
                ...
                public static class Plugin {
                    ...
                    @XmlElement(name = "distributed-file-backup-path", required = true)
                    @Mapping("fileBackupPath")
                    protected String distributedFileBackupPath;
                    ...
                    @Mapping("this")
                    protected SFTPDistributionDriverEntity.PathList.Path.PluginList.Plugin.CharacterRenamingOperation characterRenamingOperation;
                    ...
                    public String getDistributedFileBackupPath() {
                        return distributedFileBackupPath;
                    }

                    
                    public void setDistributedFileBackupPath(String value) {
                        this.distributedFileBackupPath = value;
                    }
                    ...
                    public SFTPDistributionDriverEntity.PathList.Path.PluginList.Plugin.CharacterRenamingOperation getCharacterRenamingOperation() {
                        return characterRenamingOperation;
                    }

                    
                    public void setCharacterRenamingOperation(SFTPDistributionDriverEntity.PathList.Path.PluginList.Plugin.CharacterRenamingOperation value) {
                    ...
                    public static class CharacterRenamingOperation {
                    	...
                    	@Mapping("charRenameOperationList")
                        protected List<SFTPDistributionDriverEntity.PathList.Path.PluginList.Plugin.CharacterRenamingOperation.Character> character;

                        
                        public List<SFTPDistributionDriverEntity.PathList.Path.PluginList.Plugin.CharacterRenamingOperation.Character> getCharacter() {
                            if (character == null) {
                        ...
                        public static class Character {
                            ...
                            @XmlElement(required = true)
                            protected SFTPDistributionDriverEntity.PathList.Path.PluginList.Plugin.CharacterRenamingOperation.Character.Padding padding;
                            ...
                            public SFTPDistributionDriverEntity.PathList.Path.PluginList.Plugin.CharacterRenamingOperation.Character.Padding getPadding() {
                                return padding;
                            }

                            
                            public void setPadding(SFTPDistributionDriverEntity.PathList.Path.PluginList.Plugin.CharacterRenamingOperation.Character.Padding value) {
                                this.padding = value;
                            }

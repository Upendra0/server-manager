...
CREATE PROCEDURE migrate_rule_action_rel() 
BEGIN 
   ...
   DECLARE c_curr INT ;
    ...
    DECLARE  c_tbltpolicyrulecondition CURSOR FOR SELECT RULEID, ACTIONID 
   FROM TBLTPOLICYRULEACTION_HIS ORDER BY RULEID ASC;

...
var jsSpringMsg = {};
	...
	jsSpringMsg.mtsiemensParser='<%=EngineConstants.MTSIEMENS_BINARY_PARSING_PLUGIN%>';
...
<div class="wrapper"> 
    ...
    <div class="content-wrapper"> 
        ...
        <section class="content-header">
                                        ...
                                        <div class="box-body table-responsive no-padding">
                                            <div class="nav-tabs-custom"> 
                                                ...
                                                <ul class="nav nav-tabs pull-right">
                                                    ...
                                                    <li class="<c:if test="${(REQUEST_ACTION_TYPE eq 'MTSIEMENS_PARSER_CONFIGURATION')}"><c:out value="active"></c:out></c:if>" onclick="showButtons('parser_configuration'); getMtsiemensParserConfig('<%=ControllerConstants.INIT_MTSIEMENS_PARSER_CONFIG%>');" >
                                                    	<a href="#mtsiemensConfiguration" data-toggle="tab" id="parser_configuration"><spring:message code="parsing.service.config.tab.header"></spring:message></a>
                                                    </li>
                                                    <li class="<c:if test="${(REQUEST_ACTION_TYPE eq 'MTSIEMENS_PARSER_ATTRIBUTE')}"><c:out value="active" ></c:out></c:if>" onclick="showButtons('parser_attribute_configuration'); getMtsiemensParserAttrDetails('<%=ControllerConstants.INIT_MTSIEMENS_PARSER_ATTRIBUTE%>');" >
                                                    	<a href="#mtsiemensAttribute" data-toggle="tab" id="parser_attribute_configuration"><spring:message code="parsing.service.attr.list.tab.header"></spring:message></a>
                                                    </li>
                                                  </sec:authorize>  
                                                </ul>
                                                <div class="fullwidth tab-content no-padding">
                                                <sec:authorize access="hasAnyAuthority('VIEW_PARSER')">
                                                	<div class="tab-pane <c:if test="${(REQUEST_ACTION_TYPE eq 'MTSIEMENS_PARSER_CONFIGURATION')}"><c:out value="active"></c:out></c:if>" id="mtsiemensConfiguration">
                                                		 <c:if test="${(REQUEST_ACTION_TYPE eq 'MTSIEMENS_PARSER_CONFIGURATION')}">
                                                			<jsp:include page="mtsiemensParserConfiguration.jsp" ></jsp:include>
                                                		</c:if>
                                                	</div>
                                                	
                                                	<div class="tab-pane <c:if test="${(REQUEST_ACTION_TYPE eq 'MTSIEMENS_PARSER_ATTRIBUTE')}"><c:out value="active"></c:out></c:if>" id="mtsiemensAttribute">
                                               			<c:if test="${(REQUEST_ACTION_TYPE eq 'MTSIEMENS_PARSER_ATTRIBUTE')}">
                                               				<jsp:include page="mtsiemensParserAttribute.jsp" ></jsp:include>
                                               			</c:if>
                                                	</div>
                                                	</sec:authorize>
        	...
        	<div style="display: block;">
				...
				<form id="mtsiemens-binary-parser-form" action = "" method="">
	...
	<footer class="main-footer positfix">
    	<div class="fooinn">
        	<div class="fullwidth">
       			<div class="padleft-right" id="mtsiemensParserConfigDiv" style="display: none;">
            	...
            	<div class="padleft-right" id="mtsiemens_attribute_default" style="display: none;">
				</div>
        	</div>
        	<script>
				function showHideButtonBasedOnTabsSelected(tabType){
					$("#mtsiemensParserConfigDiv").hide();
					$("#mtsiemens_attribute_default").hide();
					
					if(tabType == 'MTSIEMENS_PARSER_CONFIGURATION'){
						$("#mtsiemensParserConfigDiv").show();
					}else if(tabType == 'MTSIEMENS_PARSER_ATTR_LIST'){
						$("#mtsiemens_attribute_default").show();
					}
				}
				
				function showButtons(id){
					if(id == 'parser_configuration'){
						showHideButtonBasedOnTabsSelected('MTSIEMENS_PARSER_CONFIGURATION');
					}else if(id == 'parser_attribute_configuration'){
						showHideButtonBasedOnTabsSelected('MTSIEMENS_PARSER_ATTR_LIST');
					}
				}
			...
			$(document).ready(function() {
				...
				if(readOnlyFlag == '' || readOnlyFlag ==true){
					disableMtsiemensAdvanceDetails();	
				}
				...
				if(parserDeviceTypeId > 0 && currentTab == 'MTSIEMENS_PARSER_CONFIGURATION'){
			...
			function getMtsiemensParserConfig(action){
			
				$("#mtsiemens-binary-parser-form").attr("action",action);
				$("#mtsiemens-binary-parser-form").attr("method","GET");
				
				$("#mtsiemens-binary-parser-form #deviceName").val($("#deviceName").find(":selected").text());
				$("#mtsiemens-binary-parser-form #mappingName").val($("#mappingName").find(":selected").text());
				$("#mtsiemens-binary-parser-form #mappingId").val($("#mappingName").find(":selected").val());
				$("#mtsiemens-binary-parser-form #deviceId").val($("#deviceName").find(":selected").val());
				
				$("#mtsiemens-binary-parser-form").submit();
			}
			
			function getMtsiemensParserAttrDetails(action){
				
				$("#mtsiemens-binary-parser-form").attr("action",action);
				$("#mtsiemens-binary-parser-form").attr("method","POST");
				
				$("#mtsiemens-binary-parser-form #deviceName").val($("#deviceName").find(":selected").text());
				if($("#mtsiemens-binary-parser-form #deviceName").val() == ''){
					$("#mtsiemens-binary-parser-form #deviceName").val('${deviceName}')
				}
				
				$("#mtsiemens-binary-parser-form #mappingName").val($("#mappingName").find(":selected").text());
				if($("#mtsiemens-binary-parser-form #mappingName").val() == ''){
					$("#mtsiemens-binary-parser-form #mappingName").val('${mappingName}');
				}
				
				$("#mtsiemens-binary-parser-form #mappingId").val($("#mappingName").find(":selected").val());
				if($("#mtsiemens-binary-parser-form #mappingId").val() == ''){
					$("#mtsiemens-binary-parser-form #mappingId").val("${mappingId}");
				}
				$("#mtsiemens-binary-parser-form #deviceId").val($("#deviceName").find(":selected").val());
				if($("#mtsiemens-binary-parser-form #deviceId").val() == ''){
					$("#mtsiemens-binary-parser-form #deviceId").val('${deviceId}');
				}
				$("#mtsiemens-binary-parser-form").submit();
			}
			...
			function disableMtsiemensAdvanceDetails(){
			...
			function enableMtsiemensAdvanceDetails(){
				$("#advance_details_div_mask").remove();

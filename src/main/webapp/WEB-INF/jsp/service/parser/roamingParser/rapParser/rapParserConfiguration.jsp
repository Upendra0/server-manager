...
<div class="tab-content no-padding  mtop15">
	<div class="fullwidth mtop15">
		...
		<!-- Device details Section end here    -->
			...
			<form:form modelAttribute="<%=FormBeanConstants.ROAMING_PARSER_MAPPING_FORM_BEAN %>" method="POST" action="" id="ascii-parser-configuration-form">
			...
			<input type="hidden" id="selDeviceId" name="selDeviceId" value="${selDeviceId}">
			...
			<div class="fullwidth" id="advance_details_div">
			 <jsp:include page="../roamingAdvanceDetail.jsp"></jsp:include>
			</div> 

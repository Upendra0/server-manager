...
<div class="box box-warning">
	<div class="box-header with-border">
		<h3 class="box-title">
			<spring:message
				code="json.plugin.advance.details.heading.label" ></spring:message>
		</h3>
	...
	<div class="box-body inline-form ">
		...
		<%-- <jsp:include page="../../jsonFileHeaderDetail.jsp"></jsp:include> --%>		
		
		<div class="col-md-6 no-padding" id="enableFileFooter" style="display:none">
			<spring:message code="json.plugin.advance.details.fileFooter.enable.label" var="label" ></spring:message>
			<spring:message code="json.plugin.advance.details.fileFooter.enable.label.tooltip" var="tooltip" ></spring:message>
		...
		<div class="col-md-6 no-padding" id="fileFooterType" style="display:none">
			<spring:message code="json.plugin.advance.details.fileFooter.type.label" var="label" ></spring:message>
			<spring:message code="json.plugin.advance.details.fileFooter.type.label.tooltip" var="tooltip" ></spring:message>
			<div class="form-group">
				<div class="table-cell-label">${label}</div>
				<div class="input-group ">
		...
		<div class="col-md-6 no-padding" id="footerContains" style="display:none">
			<spring:message code="json.plugin.advance.details.fileFooter.containsField.label" var="label" ></spring:message>
			<spring:message code="json.plugin.advance.details.fileFooter.containsField.label.tooltip" var="tooltip" ></spring:message>
			<div class="form-group">
				<div class="table-cell-label">${label}</div>
				<div class="input-group ">
		...
		<div class="col-md-6 no-padding" id="findAndREplace" style="display:none">
				...
				<spring:message code="json.plugin.advance.details.find.replace.label" var="label" ></spring:message>
				<spring:message code="json.plugin.advance.details.find.replace.label.tooltip" var="tooltip" ></spring:message>
...
<div class="col-md-6 no-padding" id="recordHeaderIdentifier" style="display:none">
			<spring:message code="json.plugin.advance.details.recordHeaderIdentifier.length.label" var="label" ></spring:message>
			<spring:message code="json.plugin.advance.details.recordHeaderIdentifier.length.tooltip" var="tooltip" ></spring:message>
			<div class="form-group">
 ...
 <div class="col-md-4 no-padding" id="excludeMinCharacters" style="display:none">
			<spring:message code="json.plugin.advance.details.excludeCharacters.lable" var="label" ></spring:message>
			<spring:message code="json.plugin.advance.details.excludeCharacters.min.tooltip" var="mintooltip" ></spring:message>
			...
			<spring:message code="json.plugin.advance.details.excludeCharacters.max.tooltip" var="maxtooltip" ></spring:message>
			<div class = "form-group">
				<div class="input-group">
 ...
 <div class="col-md-6 no-padding" id="excludeLinesStartwith" style="display:none">
			<spring:message code="json.plugin.advance.details.excludeLinesStartWith.lable" var="label" ></spring:message>
			<spring:message code="json.plugin.advance.details.excludeLinesStartWith.tooltip" var="tooltip" ></spring:message>
			<div class="form-group">
				<div class="table-cell-label">${label}</div>
				<div class="input-group ">

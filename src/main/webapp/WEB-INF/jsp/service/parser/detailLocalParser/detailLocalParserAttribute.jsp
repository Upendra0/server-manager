...
<div class="tab-content no-padding  mtop15">
	<div class="fullwidth mtop15" id="attribute_details_div">
		<form:form modelAttribute="<%=FormBeanConstants.DETAIL_LOCAL_PARSER_MAPPING_FORM_BEAN %>" method="POST"
		...
		<div class="fullwidth" id="add_delete_attribute_link_div">
			<div class="title2">
				...
				<span class="title2rightfield-icon1-text" style="display: none;"> <!-- // saumil.vachheta // Mar 22, 2022 -->
...
<script type="text/javascript">
	...
	createDetailLocalAttributeGrid('<%=MapCache.getConfigValueAsInteger(SystemParametersConstant.TOTAL_ROWS_TO_DISPLAY_IN_GRID, 10)%>');
...
function addBasicDetail(){
    ...
    $.ajax({
		url: '<%=ControllerConstants.UPDATE_DETAIL_LOCAL_PARSER_MAPPING%>',
		data : oMyForm ,
        type : "POST",
        datatype: "json",
        processData: false, 
...
function getAllDetailLocalAttributeListByMappingId(urlAction, mappingId){
			...
			if(responseCode == "200"){				
				...
				if(attributeList!=null && attributeList != 'undefined' && attributeList != undefined){					
					...
					$.each(attributeList,function(index,attribute){		 				
		 				...
		 				/* rowData.attributeSeperator     = attribute.attributeSeperator;
		 				rowData.vendorNameSeparatorEnable     = attribute.vendorNameSeparatorEnable;
		 				rowData.vendorSeparatorValue     = attribute.vendorSeparatorValue; */
		 				/* rowData.portUnifiedField    = attribute.portUnifiedField;
		 				rowData.ipPortSeperator    = attribute.ipPortSeperator; */
...
function createDetailLocalAttributeGrid(defaultRowNum){	
	 $("#asciiAttributeList").jqGrid({	    	
	        ...
	        colNames:[
	                  ...
	                  /* jsSpringMsg.attributeSeperator,
	                  jsSpringMsg.vendorNameSeparatorEnable,
	                  jsSpringMsg.vendorSeparatorValue, */
			...
			colModel:[
			          ...
			          {name: 'checkbox', index: 'checkbox',sortable:false, formatter:detailLocalParserAttributeCheckboxFormatter, align : 'center', width:'30%', search : false},
					  ...
					  /* {name: 'attributeSeperator',index: 'attributeSeperator', sortable:false,search : false},
					  {name: 'vendorNameSeparatorEnable',index: 'vendorNameSeparatorEnable', sortable:false,search : false},
					  {name: 'vendorSeparatorValue',index: 'vendorSeparatorValue', sortable:false,search : false}, */
 ...
 */
function detailLocalParserAttributeCheckboxFormatter(cellvalue, options, rowObject) {

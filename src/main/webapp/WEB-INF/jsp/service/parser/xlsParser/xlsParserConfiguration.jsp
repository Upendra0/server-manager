...
<div class="tab-content no-padding  mtop15">
	<div class="fullwidth mtop15">
		...
		<!-- Device details Section end here    -->
			...
			<form:form modelAttribute="<%=FormBeanConstants.XLS_PARSER_MAPPING_FORM_BEAN %>" method="POST" action="" id="xls-parser-configuration-form">
			...
			<div class="fullwidth" id="advance_details_div">
			 <jsp:include page="xlsAdvanceDetail.jsp"></jsp:include>
			</div> 

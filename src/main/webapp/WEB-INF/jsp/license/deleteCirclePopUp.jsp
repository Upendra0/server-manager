	...
	<div class="modal-header padding10">
		<h4 class="modal-title">
			<span id="delete_label" style="display: none;"><spring:message
					code="circle.data.mgmt.circle.delete" ></spring:message></span>
		</h4>
	</div>
	<!-- Delete Popup code started -->
	<div id="divDeleteCirclePopup" style="width: 100%; display: none;">
		<div class="modal-content">
			<jsp:include page="../common/responseMsgPopUp.jsp" ></jsp:include>
			<div class="modal-body padding10 inline-form">
				<div class="fullwidth">
					<input type="hidden" value="" id="deleteCircleId"
						name="deleteCircleId" />
					<div id="delete_selected_query_details"></div>
					<div id="delete_warning" style="display: none;">
						<spring:message code="circle.delete.warning" ></spring:message>
					</div>
				</div>
			</div>
			<div id="delete_attribute_bts_div" class="modal-footer padding10">
				<button type="button" class="btn btn-grey btn-xs"
					id="delete_database_query" onclick="deleteCircle1();">
					<spring:message code="btn.label.delete" ></spring:message>
				</button>
				<button type="button" class="btn btn-grey btn-xs"
					onclick="closeFancyBox();reloadGridData();">

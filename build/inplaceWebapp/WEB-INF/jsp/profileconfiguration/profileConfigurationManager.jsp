							...
							<div class="fullwidth">
								...
								<a href="home.html"><img src="img/tile-icon.png" class="vmiddle" alt="Title Icon"/></a> 
                                    <span class="spanBreadCrumb" style="line-height: 30px;">
                                   		<strong>&nbsp;
                                   			<spring:message code="profile.management.top.heading"></spring:message>
                                   		</strong>&nbsp;
                                    </span>
								</h4>
												...
												<div class="nav-tabs-custom tab-content">
														...
														<ul class="nav nav-tabs pull-right">
															...
															<sec:authorize access="hasAnyAuthority('VIEW_PROFILE_CONFIGURATION')">
																<li class="<c:if test="${(REQUEST_ACTION_TYPE eq 'PROFILE_CONFIGURATION')}">
																	<c:out value="active"></c:out></c:if>"	>
																	<a href="#profile-configuration" id="profile_configuration"	data-toggle="tab" aria-expanded="true" onclick="showButtons('profile_configuration');"> 
																	 	<spring:message code="profile.configuration.tab.label"></spring:message> 
																	</a>
																</li>
															</sec:authorize>
														...
														<sec:authorize access="hasAnyAuthority('VIEW_PROFILE_CONFIGURATION')">
															<div id="profile-configuration"
																class="tab-pane <c:if test="${(REQUEST_ACTION_TYPE eq 'PROFILE_CONFIGURATION')}"><c:out value="active"></c:out></c:if> ">
	 														 	 	<jsp:include page="profileConfiguration.jsp"></jsp:include>  
															</div>
														</sec:authorize>
		    	...
		    	<div class="fooinn">
		    		<div class="fullwidth">
						<div class="button-set">
			            	<div class="padleft-right" id="profile_config_btn_set" style="display: none;">
			            		
			            		<sec:authorize access="hasAuthority('UPDATE_PROFILE_CONFIGURATION')">
			            				<div id ="update-configuration-buttons-div"> 
									  	<button type="button" id="edit_config_btn" class="btn btn-grey btn-xs " onclick="makeProfileTreeEnable();">
		    	 ...
		    	 <script type="text/javascript">
			       		...
			       		function showButtons(tabType){
			       			if(tabType == 'profile_configuration'){
			       				$("#profile_config_btn_set").show();
			       			}

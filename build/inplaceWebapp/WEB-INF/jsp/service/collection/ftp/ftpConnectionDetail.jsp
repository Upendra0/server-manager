...
<div class="col-md-6 no-padding">
    ...
    <div class="form-group">
        ...
        <div class="input-group ">
        	<form:input path="ftpConnectionParams.port" cssClass="form-control table-cell input-sm" id="ftp-ftpConnectionParams-port" tabindex="3" onkeydown="isNumericOnKeyDown(event)"  data-toggle="tooltip" data-placement="bottom"  title="${tooltip }"></form:input>
...
<c:if test="${(driverTypeAlias eq 'FTP_COLLECTION_DRIVER')}">
	<div class="col-md-6 no-padding">	
...
<c:if test="${(driverTypeAlias eq 'SFTP_COLLECTION_DRIVER')}">
	<div class="col-md-6 no-padding">	
		<spring:message code="ftp.driver.mgmt.config.conn.dtl.pass" var="label"></spring:message>
		<spring:message code="ftp.driver.mgmt.config.conn.dtl.pass.tooltip" var="tooltip"></spring:message>
	    <div class="form-group">
	    ...
	    <div class="form-group">
	        <div class="input-group ">
	               <jsp:include page="../../../common/testFtpSftpConnection.jsp">
			        	<jsp:param name="serviceType" value="COLLECTION" ></jsp:param>
			        </jsp:include>
	       	</div>
	     </div>
</div>

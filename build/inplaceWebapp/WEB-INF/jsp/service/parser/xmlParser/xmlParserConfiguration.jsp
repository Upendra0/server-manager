...
<div class="tab-content no-padding  mtop15">
	<div class="fullwidth mtop15">
		...
		<!-- Device details Section end here    -->
			...
			<form:form modelAttribute="<%=FormBeanConstants.XML_PARSER_MAPPING_FORM_BEAN %>" method="POST" action="" id="xml-parser-configuration-form">
			...
			<div class="fullwidth" id="advance_details_div">
				<jsp:include page="xmlAdvanceDetail.jsp"></jsp:include>
			</div> 
...
function setXMLParserAdvanceDetail(responseObject){
	
	$("#recordWiseXmlFormat").val(responseObject.recordWiseXmlFormat.toString());
	$("#commonFields").val(responseObject.commonFields);

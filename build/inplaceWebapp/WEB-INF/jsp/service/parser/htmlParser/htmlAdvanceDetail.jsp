...
<div class="box box-warning">
	...
	<div class="box-body inline-form ">
		<div class="col-md-6 no-padding" id="recordExcelFormat"
			style="display: none">
			<spring:message code="html.plugin.advance.details.excel.format.label"
				var="label" ></spring:message>
			<div class="form-group">
				<div class="table-cell-label">${label}</div>
				<div class="input-group ">

					<form:select path="recordWiseExcelFormat"
						cssClass="form-control table-cell input-sm" tabindex="2"
						id="recordWiseExcelFormat" data-toggle="tooltip"
		...
		<div class="col-md-6 no-padding" id="FileParsed" style="display: none">
			<spring:message code="html.plugin.advance.details.file.parsed.label"
				var="label" ></spring:message>
			<div class="form-group">
				<div class="table-cell-label">${label}</div>
				<div class="input-group ">

					<form:select path="isFileParsed"
						cssClass="form-control table-cell input-sm" tabindex="2"
						id="isFileParsed" data-toggle="tooltip" data-placement="bottom"
						title="${tooltip }">

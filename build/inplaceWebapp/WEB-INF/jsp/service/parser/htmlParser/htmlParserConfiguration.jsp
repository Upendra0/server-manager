...
<div class="tab-content no-padding  mtop15">
	<div class="fullwidth mtop15">
		...
		<!-- Device details Section end here    -->
			...
			<form:form modelAttribute="<%=FormBeanConstants.HTML_PARSER_MAPPING_FORM_BEAN %>" method="POST" action="" id="html-parser-configuration-form">
			...
			<div class="fullwidth" id="advance_details_div">
			 <jsp:include page="htmlAdvanceDetail.jsp"></jsp:include>
			</div> 
...
function setHtmlParserAdvanceDetail(responseObject){
	
	$("#recordWiseExcelFormat").val(responseObject.recordWiseExcelFormat.toString());
	$("#isFileParsed").val(responseObject.isFileParsed.toString());

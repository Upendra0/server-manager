...
<div class="tab-content no-padding  mtop15">
	<div class="fullwidth mtop15">
		...
		<!-- Device details Section end here    -->
			...
			<form:form modelAttribute="<%=FormBeanConstants.PDF_PARSER_MAPPING_FORM_BEAN %>" method="POST" action="" id="pdf-parser-configuration-form">
			...
			<div class="fullwidth" id="advance_details_div">
			 <jsp:include page="pdfAdvanceDetail.jsp"></jsp:include>
			</div>  
...
function setPDFParserAdvanceDetail(responseObject){
    ...
    var multiInvoice = document.getElementById('multiInvoice');
    multiInvoice.value = responseObject.multiInvoice;
    var multiPages = document.getElementById('multiPages');
    multiPages.value = responseObject.multiPages;

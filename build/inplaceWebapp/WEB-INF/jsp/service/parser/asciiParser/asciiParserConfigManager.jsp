...
<div class="wrapper"> 
                                        ...
                                        <div class="box-body table-responsive no-padding">
                                            <div class="nav-tabs-custom"> 
                                                ...
                                                <ul class="nav nav-tabs pull-right">
                                                    ...
                                                    <li class="<c:if test="${(REQUEST_ACTION_TYPE eq 'ASCII_PARSER_CONFIGURATION')}"><c:out value="active"></c:out></c:if>" onclick="showButtons('parser_configuration'); getAsciiParserConfig('<%=ControllerConstants.INIT_ASCII_PARSER_CONFIG%>');" >
                                                    ...
                                                    <li class="<c:if test="${(REQUEST_ACTION_TYPE eq 'ASCII_PARSER_ATTRIBUTE')}"><c:out value="active" ></c:out></c:if>" onclick="showButtons('parser_attribute_configuration'); getAsciiParserAttrDetails('<%=ControllerConstants.INIT_ASCII_PARSER_ATTRIBUTE%>');" >
                                                ...
                                                <sec:authorize access="hasAnyAuthority('VIEW_PARSER')">
                                                	<div class="tab-pane <c:if test="${(REQUEST_ACTION_TYPE eq 'ASCII_PARSER_CONFIGURATION')}"><c:out value="active"></c:out></c:if>" id="asciiConfiguration">
                                                		 <c:if test="${(REQUEST_ACTION_TYPE eq 'ASCII_PARSER_CONFIGURATION')}">
                                                			<jsp:include page="asciiParserConfiguration.jsp" ></jsp:include>
                                                		</c:if>
                                                	</div>
                                                	
                                                	<div class="tab-pane <c:if test="${(REQUEST_ACTION_TYPE eq 'ASCII_PARSER_ATTRIBUTE')}"><c:out value="active"></c:out></c:if>" id="asciiAttribute">
                                               			<c:if test="${(REQUEST_ACTION_TYPE eq 'ASCII_PARSER_ATTRIBUTE')}">
                                               				<jsp:include page="asciiParserAttribute.jsp" ></jsp:include>
                                               			</c:if>
                                                	</div>
                                                	</sec:authorize>
	...
	<footer class="main-footer positfix">
    	<div class="fooinn">
        	<div class="fullwidth">
       			<div class="padleft-right" id="asciiParserConfigDiv" style="display: none;">
        	...
        	<script>
				function showHideButtonBasedOnTabsSelected(tabType){
					$("#asciiParserConfigDiv").hide();
					$("#ascii_attribute_default").hide();
					
					if(tabType == 'ASCII_PARSER_CONFIGURATION'){
						$("#asciiParserConfigDiv").show();
				...
				function showButtons(id){
					if(id == 'parser_configuration'){
						showHideButtonBasedOnTabsSelected('ASCII_PARSER_CONFIGURATION');
					}else if(id == 'parser_attribute_configuration'){
						showHideButtonBasedOnTabsSelected('ASCII_PARSER_ATTR_LIST');
					}
				}
			...
			$(document).ready(function() {
				...
				if(parserDeviceTypeId > 0 && currentTab == 'ASCII_PARSER_CONFIGURATION'){
			...
			function getAsciiParserConfig(action){
			...
			function getAsciiParserAttrDetails(action){
			...
			function disableAsciiAdvanceDetails(){
			...
			function enableAsciiAdvanceDetails(){
				$("#advance_details_div_mask").remove();

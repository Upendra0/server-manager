...
<div class="tab-content no-padding  mtop15">
	<div class="fullwidth mtop15" id="attribute_details_div">
		<form:form modelAttribute="<%=FormBeanConstants.ASCII_PARSER_MAPPING_FORM_BEAN %>" method="POST"
...
function addBasicDetail(){
    ...
    $.ajax({
		url: '<%=ControllerConstants.UPDATE_ASCII_PARSER_MAPPING%>',
		data : oMyForm ,
        type : "POST",
        datatype: "json",
        processData: false, 
...
function createAsciiAttributeGrid(defaultRowNum){	
	 $("#asciiAttributeList").jqGrid({	    	
	        ...
	        colNames:[
	                  ...
	                  jsSpringMsg.portUnifiedField,
	                  jsSpringMsg.ipPortSeperator,
			...
			colModel:[
			          ...
			          {name: 'checkbox', index: 'checkbox',sortable:false, formatter:asciiParserAttributeCheckboxFormatter, align : 'center', width:'30%', search : false},
					  ...
					  {name: 'portUnifiedField',index: 'portUnifiedField', sortable:false,search : false},
					  {name: 'ipPortSeperator',index: 'ipPortSeperator', sortable:false,search : false},
 ...
 */
function asciiParserAttributeCheckboxFormatter(cellvalue, options, rowObject) {

...
<div class="tab-content no-padding  mtop15">
	<div class="fullwidth mtop15">
		...
		<!-- Device details Section end here    -->
			...
			<form:form modelAttribute="<%=FormBeanConstants.FIXED_LENGTH_ASCII_PARSER_MAPPING_FORM_BEAN %>" method="POST" action="" id="fixedLengthASCII-parser-configuration-form">
			...
			<div class="fullwidth" id="advance_details_div">
			 <jsp:include page="fixedLengthASCIIAdvanceDetail.jsp"></jsp:include>
			</div> 
...
function setFixedLengthASCIIParserAdvanceDetail(responseObject){
	var fileHeaderEnable = document.getElementById('fileHeaderEnable');
	fileHeaderEnable.value =  responseObject.fileHeaderEnable;
	var fileHeaderContainsFields = document.getElementById('fileHeaderContainsFields');
	fileHeaderContainsFields.value = responseObject.fileHeaderContainsFields;

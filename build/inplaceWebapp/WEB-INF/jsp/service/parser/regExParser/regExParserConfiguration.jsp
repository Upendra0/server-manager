...
<div class="tab-content no-padding  mtop15">
	<div class="fullwidth mtop15">
		...
		<form:form modelAttribute="regEx_parser_mapping_form_bean" method="POST" action="" id="regEx-parser-configuration-form">
    ...
    <div id="customize_mapping_div" style="width: 100%; display: none;">
			<div class="modal-content">
				...
				<div class="modal-footer padding10" id="create_mapping_button_div">
					<button type="button" class="btn btn-grey btn-xs "	data-dismiss="modal" onclick="createOrUpdateMappingDetails();"><spring:message code="btn.label.submit" ></spring:message></button>
...
function onMappingNameChange() {
	...
	var parserType = '${plugInType}';
	//Disable Save & Next button when custom is selected
	if(mappingId == '-2'){
	   $("#parser_association_save_next_btn").prop('disabled', true);
	}else{
	   $("#parser_association_save_next_btn").prop('disabled', false);
	}

...
<div class="tab-content no-padding  mtop15">
	<div class="fullwidth mtop15">
		...
		<!-- Device details Section end here    -->
			...
			<form:form modelAttribute="<%=FormBeanConstants.FIXED_LENGTH_BINARY_PARSER_MAPPING_FORM_BEAN %>" method="POST" action="" id="fixedLengthBinary-parser-configuration-form">

...
<div class="tab-content no-padding  mtop15">
	<div class="fullwidth mtop15">
		...
		<!-- Device details Section end here    -->
			...
			<form:form modelAttribute="<%=FormBeanConstants.NRTRDE_COMPOSER_MAPPING_FORM_BEAN%>" method="POST" action="" id="ascii-composer-configuration-form">
...
function setNrtrdeComposerAdvanceDetail(responseObject){

...
<div class="tab-content no-padding  mtop15">
	<div class="fullwidth mtop15">
		...
		<!-- Device details Section end here    -->
			...
			<form:form modelAttribute="<%=FormBeanConstants.ASN1_COMPOSER_MAPPING_FORM_BEAN%>" method="POST" action="" id="ascii-composer-configuration-form">
	...
	<div class="box-body inline-form ">
			...
			<jsp:include page="asn1ComposerAdvanceDetail.jsp"></jsp:include>	
...
function setAsn1ComposerAdvanceDetail(responseObject){

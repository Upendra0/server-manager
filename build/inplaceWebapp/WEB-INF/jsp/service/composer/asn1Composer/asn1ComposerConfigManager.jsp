...
var jsSpringMsg = {};
	...
	jsSpringMsg.asn1Composer='<%=EngineConstants.ASN1_COMPOSER_PLUGIN%>';
                                        ...
                                        <div class="box-body table-responsive no-padding">
                                            <div class="nav-tabs-custom"> 
                                                ...
                                                <ul class="nav nav-tabs pull-right">
                                                    ...
                                                    <li class="<c:if test="${(REQUEST_ACTION_TYPE eq 'ASN1_COMPOSER_CONFIGURATION')}"><c:out value="active"></c:out></c:if>" onclick="showButtons('composer_configuration'); getAsn1ComposerConfig('<%=ControllerConstants.INIT_ASN1_COMPOSER_MANGER%>');" >
                                                    ...
                                                    <li class="<c:if test="${(REQUEST_ACTION_TYPE eq 'ASN1_COMPOSER_ATTRIBUTE')}"><c:out value="active" ></c:out></c:if>" onclick="showButtons('composer_attribute_configuration'); getAsn1ComposerAttrDetails('<%=ControllerConstants.INIT_ASN1_COMPOSER_ATTRIBUTE%>');" >
                                                     ...
                                                     <li class="<c:if test="${(REQUEST_ACTION_TYPE eq 'ASN1_HEADER_COMPOSER_ATTRIBUTE')}"><c:out value="active" ></c:out></c:if>" onclick="showButtons('composer_header_attribute_configuration'); getAsn1ComposerAttrDetails('<%=ControllerConstants.INIT_ASN1_COMPOSER_ATTRIBUTE%>','ASN1_HEADER_COMPOSER_ATTRIBUTE');" >
                                                    	<a href="#asn1HeaderAttribute" data-toggle="tab" id="composer_header_attribute_configuration"><spring:message code="parsing.service.attr.header.list.tab.header"></spring:message></a>
                                                    </li>
                                                    <li class="<c:if test="${(REQUEST_ACTION_TYPE eq 'ASN1_TRAILER_COMPOSER_ATTRIBUTE')}"><c:out value="active" ></c:out></c:if>" onclick="showButtons('composer_trailer_attribute_configuration'); getAsn1ComposerAttrDetails('<%=ControllerConstants.INIT_ASN1_COMPOSER_ATTRIBUTE%>','ASN1_TRAILER_COMPOSER_ATTRIBUTE');" >
                                                    	<a href="#asn1TrailerAttribute" data-toggle="tab" id="composer_trailer_attribute_configuration"><spring:message code="parsing.service.attr.trailer.list.tab.header"></spring:message></a>
                                                    </li>
                                                  </sec:authorize>  
                                                </ul>
                                                <div class="fullwidth tab-content no-padding">
                                                <sec:authorize access="hasAnyAuthority('VIEW_COMPOSER')">
                                                	<div class="tab-pane <c:if test="${(REQUEST_ACTION_TYPE eq 'ASN1_COMPOSER_CONFIGURATION')}"><c:out value="active"></c:out></c:if>" id="#asn1Configuration">
                                                		 <c:if test="${(REQUEST_ACTION_TYPE eq 'ASN1_COMPOSER_CONFIGURATION')}">
                                                			<jsp:include page="asn1ComposerConfiguration.jsp" ></jsp:include>
                                                		</c:if>
                                                	</div>
                                                	
                                                	<div class="tab-pane <c:if test="${(REQUEST_ACTION_TYPE eq 'ASN1_COMPOSER_ATTRIBUTE')}"><c:out value="active"></c:out></c:if>" id="asn1Attribute">
                                               			<c:if test="${(REQUEST_ACTION_TYPE eq 'ASN1_COMPOSER_ATTRIBUTE')}">
                                               				<jsp:include page="asn1ComposerAttribute.jsp" ></jsp:include>
                                               			</c:if>
                                                	</div>
                                                	<div class="tab-pane <c:if test="${(REQUEST_ACTION_TYPE eq 'ASN1_HEADER_COMPOSER_ATTRIBUTE')}"><c:out value="active"></c:out></c:if>" id="asn1HeaderAttribute">
                                               			<c:if test="${(REQUEST_ACTION_TYPE eq 'ASN1_HEADER_COMPOSER_ATTRIBUTE')}">
                                               				<jsp:include page="asn1ComposerAttribute.jsp" ></jsp:include>
                                               			</c:if>
                                                	</div>
                                                	<div class="tab-pane <c:if test="${(REQUEST_ACTION_TYPE eq 'ASN1_TRAILER_COMPOSER_ATTRIBUTE')}"><c:out value="active"></c:out></c:if>" id="asn1TrailerAttribute">
                                               			<c:if test="${(REQUEST_ACTION_TYPE eq 'ASN1_TRAILER_COMPOSER_ATTRIBUTE')}">
                                               				<jsp:include page="asn1ComposerAttribute.jsp" ></jsp:include>
                                               			</c:if>
                                                	</div>
                                                	</sec:authorize>
...
<script>
	function showHideButtonBasedOnTabsSelected(tabType){
		...
		if(tabType == 'ASN1_COMPOSER_CONFIGURATION'){
			$("#asn1ComposerConfigDiv").show();
		}else if(tabType == 'ASN1_COMPOSER_ATTR_LIST'){
			$("#asn1_attribute_default").show();
			$("#asn1ComposerConfigbtnDiv").show();
		}else if(tabType == 'ASN1_COMPOSER_HEADER_ATTR_LIST'){
			$("#asn1_header_attribute_default").show();
			$("#asn1ComposerConfigbtnDiv").show();
		}else if(tabType == 'ASN1_COMPOSER_TRAILER_ATTR_LIST'){
	...
	function showButtons(id){
		if(id == 'composer_configuration'){
			showHideButtonBasedOnTabsSelected('ASN1_COMPOSER_CONFIGURATION');
		}else if(id == 'composer_attribute_configuration'){
			showHideButtonBasedOnTabsSelected('ASN1_COMPOSER_ATTR_LIST');
		}else if(id == 'composer_header_attribute_configuration'){
			showHideButtonBasedOnTabsSelected('ASN1_COMPOSER_HEADER_ATTR_LIST');
		}else if(id == 'composer_trailer_attribute_configuration'){
			showHideButtonBasedOnTabsSelected('ASN1_COMPOSER_TRAILER_ATTR_LIST');
		}
	}
...
$(document).ready(function() {
	...
	if(composerDeviceTypeId > 0 && currentTab == 'ASN1_COMPOSER_CONFIGURATION'){
...
function getAsn1ComposerConfig(action){
...
function getAsn1ComposerAttrDetails(action,attributeType){

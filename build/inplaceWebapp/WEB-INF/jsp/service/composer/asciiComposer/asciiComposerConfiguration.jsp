...
<div class="tab-content no-padding  mtop15">
	<div class="fullwidth mtop15">
		...
		<form:form modelAttribute="ascii_composer_mapping_form_bean" method="POST" action="" id="ascii-composer-configuration-form">
			...
			<div class="fullwidth" id="advance_details_div">
				<div class="box box-warning">
					<div class="box-header with-border">
						<h3 class="box-title">
							<spring:message code="ascii.plugin.advance.details.heading.label" ></spring:message>
						</h3>
					...
					<div class="box-body inline-form ">				
						...
						<jsp:include page="../../asciiFileFooterDetail.jsp"></jsp:include>						
					</div> 
			...
			<div class="fullwidth" id="header_footer_summary">
				<div class="box box-warning">
					<div class="box-header with-border">
						<h3 class="box-title">
							<spring:message code="ascii.plugin.headerfooter.summary.heading.label" ></spring:message>
						</h3>
						<div class="box-tools pull-right">
							<button class="btn btn-box-tool" data-widget="collapse">
								<i class="fa fa-minus"></i>
					...
					<div class="box-body inline-form ">			
						<jsp:include page="../../asciiFileHeaderFooterSummary.jsp"></jsp:include>											 												
					</div> 
				</div>
			</div>		
		</form:form>		
...
$(document).ready(function() {
	...
	$("#headerContains").show();
	$("#fieldSep").show();
	$("#enableFileHeaderSummary").show();
	$("#enableFileFooterSummary").show();
...
function setAsciiComposerAdvanceDetail(responseObject){
	...
	if(separatorFind == false){
		...
		if(responseObject.fieldSeparator == ' '){
			...
			$("#fieldSeparator").val('');
			$("#fieldSeparator").attr('readOnly',true);
		}else if(responseObject.fieldSeparator == '    '){
			$("#fieldSepValues").val('ssss');
			$("#fieldSeparator").val('');
			$("#fieldSeparator").attr('readOnly',true);
		}
		else{

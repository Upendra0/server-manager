    ...
    b.prototype = {
        ...
        add: function(b, c) {
            ...
            if (!(d.options.maxTags && d.itemsArray.length >= d.options.maxTags || b !== !1 && !b)) {
                ...
                if (!b.toString().match(/^\s*$/)) {
                    ...
                    if (!a.grep(d.itemsArray, function(a) {
                            return d.options.itemValue(a) === h
                        })[0]) {
                        d.itemsArray.push(b);
                        var k = a('<span class="tag ' + e(j) + '">' + e(i) + '<span data-role="remove"></span></span>');
                        if (k.data("item", b), d.findInputWrapper().before(k), k.after(" "), d.isSelect && !a('option[value="' + escape(h) + '"]', d.$element)[0]) {
                            var l = a("<option selected>" + e(i) + "</option>");
                            l.data("item", b), l.attr("value", h), d.$element.append(l)
                        }
                        c || d.pushVal(), d.options.maxTags === d.itemsArray.length && d.$container.addClass("bootstrap-tagsinput-max"), d.$element.trigger(a.Event("itemAdded", {
                            item: b
                        }))
                    }
                }
        ...
        remove: function(b, c) {
            ...
            d.objectItems && (b = "object" == typeof b ? a.grep(d.itemsArray, function(a) {
                ...
                return a(this).data("item") === b
            }).remove(), d.itemsArray.splice(d.itemsArray.indexOf(b), 1)), c || d.pushVal(), d.options.maxTags > d.itemsArray.length && d.$container.removeClass("bootstrap-tagsinput-max"), d.$element.trigger(a.Event("itemRemoved", {
                item: b
            }))
        },
        removeAll: function() {
        ...
        destroy: function() {
            var a = this;
            a.$container.off("keypress", "input"), a.$container.off("click", "[50role=remove]"), a.$container.remove(), a.$element.removeData("tagsinput"), a.$element.show()
        },
        focus: function() {
            this.$input.focus()
        },

...
public final class startServicePopUp_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t        <input type=\"hidden\" id=\"startServiceId\" /> \n");
      out.write("\t\t\t        <p>\n");
      out.write("\t\t\t        \t<table>\n");
      out.write("\t\t\t        \t\t<tr>\n");
      out.write("\t\t\t        \t\t\t<td>\n");
      out.write("\t\t\t        \t\t\t\t<img alt=\"Service Instance\" src=\"img/ftp-img.png\" class=\"img-responsive\" />\n");
      out.write("\t\t\t        \t\t\t</td>\n");
      ...
      if (_jspx_meth_spring_005fmessage_005f1(_jspx_page_context))
        return;
      out.write("\n");
      out.write("\t\t\t        \t\t\t\t&nbsp;&nbsp;<label id=\"lblServiceId\"> SVC</label> <br/>\t\t\n");
      out.write("\t\t\t        \t\t\t\t");
      if (_jspx_meth_spring_005fmessage_005f2(_jspx_page_context))
        return;
      out.write("\n");
      out.write("\t\t\t        \t\t\t\t&nbsp;&nbsp;<label id=\"lblServiceName\">ServiceName</label><br/>\n");
      out.write("\t\t\t        \t\t\t</td>\n");
      out.write("\t\t\t        \t\t</tr>\n");
      out.write("\t\t\t        \t</table>\n");
      out.write("\t\t\t       \n");
      ...
      out.write("           \t\n");
      out.write("\t\t\t        </p>\n");
      out.write("\t\t\t        <div id=\"syncWarningMsg\" style=\"color: #FF0000 ; display: none;\">\n");
      out.write("\t\t\t        <p>\t\n");
      out.write("\t\t\t\t\t\t");
      ...
      out.write("\t\t\t        </p>\n");
      out.write("\t\t        </div>\n");
      out.write("\t\t        <div id=\"start-buttons-div\" class=\"modal-footer padding10\">\n");
      out.write("\t\t        \t");
      if (_jspx_meth_sec_005fauthorize_005f0(_jspx_page_context))
        return;
      out.write("\n");
      out.write("\t\t            <button type=\"button\" class=\"btn btn-grey btn-xs\" id=\"service-start-close-btn\" data-dismiss=\"modal\" onclick=\"closeFancyBox();searchInstanceCriteria();\">");
      if (_jspx_meth_spring_005fmessage_005f8(_jspx_page_context))
        return;
      out.write("</button>\n");
      out.write("\t\t            <button type=\"button\" class=\"btn btn-grey btn-xs\" id=\"server-start-close-btn\" data-dismiss=\"modal\" onclick=\"closeFancyBox();resetCheckBox('start');\">");
      if (_jspx_meth_spring_005fmessage_005f9(_jspx_page_context))
        return;
      out.write("</button>\n");
      out.write("\t\t        </div>\n");
      out.write("\t\t        <div id=\"start-progress-bar-div\" class=\"modal-footer padding10 text-left\" style=\"display: none;\">\n");
      out.write("\t\t\t\t\t");
      ...
      out.write("\t\t  \n");
      out.write("\t\t  function startServiceInstance(){\n");
      out.write("\t\t\t \n");
      out.write("\t\t\t\t$(\"#start-buttons-div\").hide();\n");
      out.write("\t\t\t\t$(\"#start-progress-bar-div\").show();\n");
      out.write("\t\t\t\t\n");
      out.write("\t\t\t\tvar serviceInstanceId ;\n");
      out.write("\t\t\t\tvar serviceStatus;\n");
      out.write("\t\t\t\t\n");
      out.write("\t\t\t\tif(currentTab == 'SERVICE_MANAGEMENT'){\n");
      out.write("\t\t\t\t\tserviceInstanceId = ckIntanceSelected.join();\n");
      out.write("\t\t\t\t}\n");
      out.write("\t\t\t\t\n");
      out.write("\t\t\t\tif(currentTab == 'COLLECTION_SERVICE_SUMMARY'){\n");
      out.write("\t\t\t\t\tserviceInstanceId = $(\"#serviceId\").val();\n");
      out.write("\t\t\t\t}\n");
      out.write("\t\t\t\tif(currentTab == 'NETFLOW_COLLECTION_SERVICE_SUMMARY' || currentTab == 'PROCESSING_SERVICE_SUMMARY' || currentTab == 'CONSOLIDATION_SERVICE_SUMMARY'\n");
      out.write("\t\t\t\t\t\t|| currentTab == 'DIAMETER_COLLECTION_SERVICE_SUMMARY'){\n");
      out.write("\t\t\t\t\tserviceInstanceId = $(\"#serviceId\").val();\n");
      out.write("\t\t\t\t}\n");
      out.write("\t\t\t\tif(currentTab == 'UPDATE_INSTANCE_SUMMARY'){\n");
      out.write("\t\t\t\t\tserviceInstanceId = $(\"#startServiceId\").val();\n");
      out.write("\t\t\t\t}\n");
      out.write("\t\t\t\tif(currentTab == 'IPLOG_SERVICE_SUMMARY'){\n");
      out.write("\t\t\t\t\tserviceInstanceId = $(\"#startServiceId\").val();\n");
      out.write("\t\t\t\t}\n");
      out.write("\t\t\t\tif(currentTab == 'PARSING_SERVICE_SUMMARY'){\n");
      out.write("\t\t\t\t\tserviceInstanceId = $(\"#startServiceId\").val();\n");
      out.write("\t\t\t\t}\n");
      out.write("\t\t\t\t\n");
      ...
      out.write("\t\t\t\t $.ajax({\n");
      out.write("\t\t\t\t\turl: '");
      out.print( ControllerConstants.START_SERVICE_INSTANCE );
      out.write("',\n");
      ...
      out.write("\t\t\t\t\t\tdata: {\n");
      out.write("\t\t\t\t\t\t\tid: serviceInstanceId\n");
      out.write("\t\t\t\t\t\t},\n");
      ...
      out.write("\t\t\t\t\t    \t\t\n");
      out.write("\t\t\t\t\t    \t}else{\n");
      out.write("\t\t\t\t\t    \t\t$('#'+serviceInstanceId +'_INACTIVE').bootstrapToggle('off');\n");
      out.write("\t\t\t\t\t    \t\tshowErrorMsgPopUp(response.msg);\n");
      out.write("\t\t\t\t\t    \t\tcloseFancyBox();\n");
      out.write("\t\t\t\t\t    \t}\n");
      out.write("\t\t\t\t\t    \t\n");
      out.write("\t\t\t\t\t    \tif(currentTab == 'SERVICE_MANAGEMENT' ){\n");
      out.write("\t\t\t\t    \t\t\tloadServiceStatusGUI(serviceInstanceId,'service_management');\n");
      out.write("\t\t\t\t\t\t\t}\n");
      out.write("\t\t\t\t\t\t\t\n");
      out.write("\t\t\t\t\t    \tif(currentTab == 'UPDATE_INSTANCE_SUMMARY' ){\n");
      out.write("\t\t\t\t    \t\t\tloadServiceStatusGUI(serviceInstanceId,'service_management');\n");
      out.write("\t\t\t\t\t\t\t}\n");
      out.write("\t\t\t\t\t\t\tif(currentTab == 'COLLECTION_SERVICE_SUMMARY'){\n");
      out.write("\t\t\t\t\t\t\t\tloadServiceStatusGUI(serviceInstanceId,'collection_summary');\n");
      out.write("\t\t\t\t\t\t\t}\n");
      out.write("\t\t\t\t\t\t\tif(currentTab == 'NETFLOW_COLLECTION_SERVICE_SUMMARY'){\n");
      out.write("\t\t\t\t\t\t\t\tloadServiceStatusGUI(serviceInstanceId,'netflow_collection_summary');\n");
      out.write("\t\t\t\t\t\t\t}\n");
      out.write("\t\t\t\t\t\t\tif(currentTab == 'IPLOG_SERVICE_SUMMARY'){\n");
      out.write("\t\t\t\t\t\t\t\tloadServiceStatusGUI(serviceInstanceId,'iplog_service_summary');\n");
      out.write("\t\t\t\t\t\t\t}\n");
      out.write("\t\t\t\t\t\t\tif(currentTab == 'PARSING_SERVICE_SUMMARY'){\n");
      out.write("\t\t\t\t\t\t\t\tloadServiceStatusGUI(serviceInstanceId,'parsing_service_summary');\n");
      out.write("\t\t\t\t\t\t\t}\n");
      out.write("\t\t\t\t\t\t\tif(currentTab == 'PROCESSING_SERVICE_SUMMARY'){\n");
      out.write("\t\t\t\t\t\t\t\tloadServiceStatusGUI(serviceInstanceId,'processing_service_summary');\n");
      out.write("\t\t\t\t\t\t\t}\n");
      out.write("\t\t\t\t\t\t\tif(currentTab == 'PROCESSING_SERVICE_SUMMARY'){\n");
      out.write("\t\t\t\t\t\t\t\tloadServiceStatusGUI(serviceInstanceId,'consolidation_service_summary');\n");
      out.write("\t\t\t\t\t\t\t}\n");
      out.write("\t\t\t\t\t\t},\n");
      ...
      out.write("\t\t\t\t\t    \t\tckIntanceSelected = new Array();\n");
      out.write("\t\t\t\t\t    \t\tcloseFancyBox();\n");
      out.write("\t\t\t\t\t    \t\tshowSuccessMsg(\"A start call has been initiated to the service it should update in a while,if not try reloading the page or starting it again to view the changes.\");\n");
      out.write("\t\t\t\t\t    \t}\n");
      out.write("\t\t\t\t\t    \t$(\"#start-buttons-div\").show();\n");
      out.write("\t\t\t\t\t\t\t$(\"#start-progress-bar-div\").hide();\n");
  ...
  private boolean _jspx_meth_spring_005fmessage_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/jsp/service/startServicePopUp.jsp(6,38) name = code type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_spring_005fmessage_005f0.setCode("serviceMgmt.start.popup.header");
  ...
  private boolean _jspx_meth_spring_005fmessage_005f1(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/jsp/service/startServicePopUp.jsp(17,15) name = code type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_spring_005fmessage_005f1.setCode("serviceManagement.grid.column.service.id");
  ...
  private boolean _jspx_meth_spring_005fmessage_005f2(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/jsp/service/startServicePopUp.jsp(19,15) name = code type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_spring_005fmessage_005f2.setCode("serviceManagement.grid.column.service.name");
  ...
  private boolean _jspx_meth_spring_005fmessage_005f3(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/jsp/service/startServicePopUp.jsp(26,72) name = code type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_spring_005fmessage_005f4(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/jsp/service/startServicePopUp.jsp(29,6) name = code type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_spring_005fmessage_005f4.setCode("serviceMgmt.start.popup.note.content");
  ...
  private boolean _jspx_meth_spring_005fmessage_005f5(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/jsp/service/startServicePopUp.jsp(33,6) name = code type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_spring_005fmessage_005f5.setCode("serviceMgmt.start.popup.note.sync.warning.content");
  ...
  private boolean _jspx_meth_spring_005fmessage_005f6(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/jsp/service/startServicePopUp.jsp(37,20) name = code type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_spring_005fmessage_005f6.setCode("serviceMgmt.start.popup.continue.message");
  ...
  private boolean _jspx_meth_sec_005fauthorize_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/jsp/service/startServicePopUp.jsp(41,11) name = access type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_sec_005fauthorize_005f0.setAccess("hasAuthority('START_SERVICE_INSTANCE')");
      int _jspx_eval_sec_005fauthorize_005f0 = _jspx_th_sec_005fauthorize_005f0.doStartTag();
      if (_jspx_eval_sec_005fauthorize_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        out.write("\n");
        out.write("\t\t            \t<button type=\"button\" class=\"btn btn-grey btn-xs\" id=\"service-start-btn\" onclick=\"startServiceInstance();\">");
  ...
  private boolean _jspx_meth_spring_005fmessage_005f7(javax.servlet.jsp.tagext.JspTag _jspx_th_sec_005fauthorize_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/jsp/service/startServicePopUp.jsp(42,122) name = code type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_spring_005fmessage_005f7.setCode("btn.label.yes");
  ...
  private boolean _jspx_meth_spring_005fmessage_005f8(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/jsp/service/startServicePopUp.jsp(44,166) name = code type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_spring_005fmessage_005f8.setCode("btn.label.no");
  ...
  private boolean _jspx_meth_spring_005fmessage_005f9(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/jsp/service/startServicePopUp.jsp(45,163) name = code type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
